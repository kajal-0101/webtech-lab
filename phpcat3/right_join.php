				...
				<div class="table-responsive">
					<table>
						...
						<tbody>
							<?php
								include "connect.php";
								$joinquery = "SELECT * FROM buy RIGHT JOIN item ON item.product = buy.item";
								...
								if($nums > 0){
									...
									?>
									<tr>
										<td><?php if ($res['id'] == ''){echo "NIL";} else{echo $res['id'];}?></td>
										<td><?php if ($res['name'] == ''){echo "NIL";} else{echo $res['name'];} ?></td>
										<td><?php if ($res['mobile'] == ''){echo "NIL";} else{echo $res['mobile'];}?></td>
										<td><?php if ($res['address'] == ''){echo "NIL";} else{echo $res['address'];} ?></td>
										<td><?php if ($res['sport'] == ''){echo "NIL";} else{echo $res['sport'];} ?></td>
										<td><?php if ($res['item'] == ''){echo $res['product'];} else{echo $res['item'];} ?></td>
										<td><?php if ($res['quantity'] == ''){echo $res['colour'];} else{echo $res['quantity'];} ?></td>
